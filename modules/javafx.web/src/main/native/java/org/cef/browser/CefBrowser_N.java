...
import org.cef.javafx.CefKeyEvent;
import org.cef.javafx.CefMouseEvent;
import org.cef.javafx.CefMouseWheelEvent;
...
abstract class CefBrowser_N extends CefNativeAdapter implements CefBrowser {
     ...
     * @param e The event to send.
     */
    protected final void sendKeyEventFX(javafx.scene.input.KeyEvent e) {
        try {
            N_SendKeyEventFX(new CefKeyEvent(e));
            e.consume();
        } catch (UnsatisfiedLinkError ule) {
            ule.printStackTrace();
        }
     ...
     * @param e The event to send.
     */
    protected final void sendMouseEventFX(javafx.scene.input.MouseEvent e) {
        try {
            N_SendMouseEventFX(new CefMouseEvent(e));
            e.consume();
        } catch (UnsatisfiedLinkError ule) {
            ule.printStackTrace();
        }
     ...
     * @param e The event to send.
     */
    protected final void sendMouseWheelEventFX(ScrollEvent e) {
        try {
            N_SendMouseWheelEventFX(new CefMouseWheelEvent(e));
            e.consume();
        } catch (UnsatisfiedLinkError ule) {
            ule.printStackTrace();
        }
    ...
    private final native void N_SendKeyEventFX(CefKeyEvent e);
    private final native void N_SendMouseEvent(MouseEvent e);
    private final native void N_SendMouseEventFX(CefMouseEvent e);
    private final native void N_SendMouseWheelEvent(MouseWheelEvent e);
    private final native void N_SendMouseWheelEventFX(CefMouseWheelEvent e);
